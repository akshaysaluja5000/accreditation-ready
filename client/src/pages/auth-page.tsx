                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <p className="text-xs text-muted-foreground mt-1">
                            This keeps your team's progress private. Use the code your administrator shared, or pick a new one if you are the first from your facility - everyone who joins with the same code becomes part of the same group.
                          </p>
                          <FormMessage />
                        </FormItem>
                      )}
