...
const hospitalLevelsRaw: Level[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: "pc21",
        question: "An orthopedic surgeon completes a preop H&P covering all four required elements and the patient signs an informed consent form. A surveyor reviews the record and cites a documentation gap. What is the most likely deficiency?",
        options: [
          "Anesthesia must co-sign the H&P before the preop record is complete for any surgical procedure.",
          "Signed consent alone is not sufficient — the preop note or H&P must also document that a risks-and-benefits discussion occurred with the patient.",
          "Nothing is missing. A completed H&P and signed consent form together constitute a compliant preop record.",
          "Risks-and-benefits documentation belongs in the operative report, not in the preop note or H&P.",
        ],
        correctIndex: 1,
        explanation: "A signed consent form documents the patient's agreement but does not substitute for the physician's clinical note confirming that the risks, benefits, and alternatives were actually discussed. JC requires the medical record to contain evidence that the informed consent process occurred — typically a notation in the preop or H&P note that the discussion took place.",
        xpReward: 15,
        isSwipe: false,
      },
      {
        id: "pc22",
        question: "Your orthopedic patient has limited English proficiency. The surgeon's preop note documents all four H&P elements and that a risks-and-benefits discussion occurred. No interpreter is mentioned anywhere in the record. The surgeon confirms the patient's son translated. How many documentation deficiencies are present?",
        options: [
          "None — the preop note is complete once it captures the four H&P elements and confirms the discussion occurred.",
          "One — the preop note must identify the qualified interpreter used for the risks-and-benefits discussion.",
          "Two — the preop note must document that a qualified interpreter was used, and using a family member for a consent discussion rather than a professional interpreter is itself a patient rights violation.",
          "Three — additionally, a translated copy of the consent form must be attached whenever an interpreter was required.",
        ],
        correctIndex: 2,
        explanation: "Two violations are present. First, using a family member to interpret a risks-and-benefits or consent discussion instead of a qualified professional interpreter violates patient rights standards — family members introduce conflicts of interest and may filter information. Second, the preop record must document who provided interpretation. Both the choice of interpreter and the documentation gap are independently citable findings.",
        xpReward: 20,
        isSwipe: false,
      },
    ],
  ...
  // ── MEDICATION MANAGEMENT ──────────────────────────────────────────────────
  {
    ...
    questions: [
      ...
      {
        id: "mm21",
        question: "A post-op patient reports 7/10 pain. The physician has ordered morphine 2 mg IV q4h PRN for pain ≥ 5. Your nurse administers acetaminophen instead without contacting the physician, noting 'I prefer to start with non-opioids.' No new order was obtained. What is the primary compliance issue?",
        options: [
          "The nurse substituted a different medication without a physician order. Medications must be administered as ordered; substituting requires prescriber contact and a new order.",
          "Documentation only — the substitution was clinically appropriate, but the nurse needed to record the rationale in the MAR and notify the charge nurse before proceeding.",
          "Acetaminophen is a recognized first-line analgesic, so clinical equivalence permits the substitution without a new order when the nurse documents the safety rationale.",
          "Charge nurse authorization is sufficient to administer an alternative analgesic when the substitution is in the patient's interest and is documented before administration.",
        ],
        correctIndex: 0,
        explanation: "Nurses must administer medications as ordered. Substituting a different drug — even with good clinical intent — without contacting the prescriber and obtaining a new order violates medication management standards. The correct action when a nurse disagrees with an order is to contact the physician, not to act unilaterally.",
        xpReward: 15,
        isSwipe: false,
      },
      {
        id: "mm22",
        question: "A physician orders oxycodone 10 mg PO q6h PRN for pain. Your nurse administers doses at 3-hour intervals because the patient keeps requesting it and appears to be in genuine distress. No contact is made with the physician. What is the finding?",
        options: [
          "PRN orders allow professional discretion on timing — nurses may shorten intervals based on documented pain assessments when patient distress is acute.",
          "Administering at shorter intervals than ordered without prescriber authorization violates medication management standards. Compassionate intent does not substitute for a new or revised order.",
          "Nothing additional is required as long as each dose is charted with the corresponding pain score that prompted administration.",
          "Charge nurse cosignature on each early dose is sufficient authorization to deviate from the prescribed interval without a formal order change.",
        ],
        correctIndex: 1,
        explanation: "A PRN order specifies the minimum interval between doses. Giving doses more frequently than ordered without a new order from the prescriber is non-compliant regardless of the patient's reported pain level. The nurse's obligation is to contact the physician and request a revised order, not to override the existing one.",
        xpReward: 15,
        isSwipe: false,
      },
    ],
  ...
  // ── PATIENT RIGHTS & RESPONSIBILITIES ─────────────────────────────────────
  {
    ...
    questions: [
      ...
      {
        id: "pr21",
        question: "A surgeon discusses the risks and benefits of a scheduled orthopedic procedure with a patient who has limited English proficiency. The patient's adult son translates throughout the conversation. The patient signs the consent form. What patient rights violation has occurred?",
        options: [
          "Using a family member as interpreter for a clinical consent discussion instead of a qualified professional interpreter violates the patient's right to receive healthcare information in a language they can accurately understand.",
          "Nothing — the patient's right to choose their own interpreter was honored, and the signed consent form confirms the patient agreed to proceed.",
          "Consent is valid as long as the patient signs willingly; interpreter selection is a facility preference, not a patient rights requirement.",
          "Only a documentation issue — using a family interpreter is permitted when the patient prefers it, but the choice of interpreter must be noted in the chart.",
        ],
        correctIndex: 0,
        explanation: "JC requires that professional interpreter services be offered first for all clinical discussions, including consent and risks-and-benefits conversations. Family members may not interpret for consent discussions because they introduce conflicts of interest and may omit, soften, or alter clinical information. The correct process: offer professional interpreter services, document the offer, and only permit family interpretation for non-clinical conversations if the patient explicitly requests it after the offer.",
        xpReward: 15,
        isSwipe: false,
      },
    ],
