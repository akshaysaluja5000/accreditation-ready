...
const hospitalLevelsRaw: Level[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation: "A housekeeping cart left unattended in a hallway is a finding even when the cart is locked. Joint Commission surveyors consistently cite unattended carts containing hazardous chemicals as a patient safety and hazardous materials concern under PE.02 (formerly EC.02.02.01). Carts with chemicals must be returned to the locked EVS closet when the worker is not present to supervise them. A locked cart is not sufficient if it is left unattended and accessible in a patient corridor.",
        xpReward: 15,
        isSwipe: false,
      },
      {
    ...
    questions: [
      {
        ...
        correctIndex: 1,
        explanation: "Room number is never an acceptable patient identifier under NPG 1 / formerly NPSG.01.01.01. Two patient-specific identifiers are required, name plus date of birth or medical record number. Room number is not patient-specific because patients move between rooms. The wristband name alone satisfies one identifier; a second must be actively verified.",
        xpReward: 15,
        isSwipe: false,
      },
      {
        ...
        correctIndex: 2,
        explanation: "NPG 1 / formerly NPSG.02.03.01 requires a complete read-back for all verbal and telephone orders. After writing the order, the nurse must read it back completely to the physician and receive confirmation that it is correct before hanging up. This step must be documented. Simply writing the order without reading it back does not satisfy the requirement.",
        xpReward: 15,
        isSwipe: false,
      },
      {
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation: "A patient without an identification band must have one applied before any treatment, medication, or specimen collection. The two-identifier requirement cannot be satisfied with room number or familiarity. NPG 1 / formerly NPSG.01.01.01 applies to every episode of care, there are no exceptions for 'known' patients.",
        xpReward: 15,
        isSwipe: false,
      },
      {
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    questions: [
      {
        id: "em1",
        question: "A Joint Commission surveyor stops an OR nurse in the hallway and asks: 'What would you do if the hospital declared a mass casualty event right now?' The nurse says, 'I'd wait for my charge nurse to tell me.' Is this an adequate answer?",
        options: [
          "Yes, following the chain of command is the correct first step in any emergency response",
          "No, the nurse should know her specific MCI role and duties without waiting to be told",
        ...
        correctIndex: 1,
        explanation: "Frontline staff must know their specific role in the Emergency Operations Plan. 'Wait for my charge nurse' indicates the staff member does not know their duties during a declared emergency, which is a training compliance finding under EM.02.02.01. Surveyors expect every staff member to describe their specific actions, not just defer up the chain.",
        xpReward: 15,
        isSwipe: false,
      },
      {
        id: "em2",
        question: "How often must a hospital update its Hazard Vulnerability Analysis (HVA)?",
        options: [
        ...
        correctIndex: 2,
        explanation: "Joint Commission standard EM.02.01.01 requires the HVA to be updated at least annually. The local hazard environment changes, new industrial facilities open, climate patterns shift, community demographics change. An HVA that hasn't been reviewed in more than a year does not meet the standard.",
        xpReward: 10,
        isSwipe: false,
      },
      {
        id: "em3",
        question: "A hospital's Emergency Operations Plan was downloaded from a state health department template website and filed without modification. A surveyor reviews it during an inspection. What is the most likely finding?",
        options: [
        ...
        correctIndex: 2,
        explanation: "The EOP must be facility-specific. A generic template that doesn't reflect the hospital's unique hazard profile (from the HVA), actual resources, community relationships, and staff roles does not meet EM.01.01.01. Surveyors look for evidence the plan was built around the specific facility, not downloaded and filed.",
        xpReward: 15,
        isSwipe: false,
      },
      {
        id: "em4",
        question: "Which person or body has the authority to activate the hospital's Emergency Operations Plan?",
        options: [
      ...
      {
        id: "em5",
        question: "The HVA for a hospital in Arizona lists hurricanes as a high-probability, high-impact threat. A surveyor reviews this. What is the concern?",
        options: [
          "No concern, hurricanes in the southwest U.S. are more common than most people realize",
          "The HVA is not facility-specific; it appears to be a generic template not based on actual local conditions",
          "The concern is the impact rating, hurricanes should be rated medium impact in inland regions",
          "No concern, the Joint Commission requires all natural disasters be listed regardless of local probability",
        ],
        correctIndex: 1,
        explanation: "Arizona has extremely low hurricane risk. Listing hurricanes as high-probability in an Arizona HVA is a clear indicator that the facility used a non-specific template rather than conducting a genuine local hazard analysis. EM.02.01.01 requires the HVA to reflect actual local and regional conditions, this is a significant finding.",
        xpReward: 15,
        isSwipe: false,
      },
      {
        id: "em6",
        question: "Which of the following is NOT one of the six critical areas required by Joint Commission standard EM.02.02.01?",
        options: [
          "Communications",
        ...
        correctIndex: 2,
        explanation: "The six required critical areas under EM.02.02.01 are: (1) Communications, (2) Resources and assets, (3) Safety and security, (4) Staff responsibilities, (5) Utilities management, and (6) Patient clinical and support activities. Financial and billing continuity is not one of the six required areas, though it may be addressed separately in business continuity planning.",
        xpReward: 10,
        isSwipe: false,
      },
      {
        id: "em7",
        question: "A hospital loses its main phone system during a severe ice storm. Which critical area of the EOP specifically addresses how the facility will communicate under these conditions?",
        options: [
          "Safety and security",
          "Utilities management",
          "Communications",
        ...
        correctIndex: 2,
        explanation: "The Communications critical area of the EOP (EM.02.02.01) must address how the facility will maintain internal and external communications when primary systems fail. This includes backup systems such as satellite phones, two-way radios, runners, and pre-established communication trees. A downed phone system with no backup plan is a gap in this critical area.",
        xpReward: 10,
        isSwipe: false,
      },
      {
        id: "em8",
        question: "During a mass casualty event, the emergency department is overwhelmed. The hospital's EOP activates a plan to convert a conference room into an overflow treatment area and discharge stable floor patients. Which critical area of the EOP does this represent?",
        options: [
          "Safety and security",
          "Utilities management",
          "Staff responsibilities",
        ...
        correctIndex: 3,
        explanation: "The Patient Clinical and Support Activities critical area addresses how the hospital will continue and expand care during an emergency, including surge capacity planning, care space expansion, patient discharge acceleration, and prioritization of care resources. Converting space and discharging stable patients is surge capacity activation, a required element of this critical area.",
        xpReward: 15,
        isSwipe: false,
      },
      {
        id: "em9",
        question: "A hazmat incident occurs one block from the hospital. Leadership determines that evacuating patients would expose them to the chemical agent in the air outside. What is the correct protective action?",
        options: [
          "Evacuate all patients and staff immediately using the facility's standard evacuation routes",
        ...
        correctIndex: 1,
        explanation: "For external hazmat incidents, shelter-in-place is typically the correct protective action, keeping patients inside the building protects them from outdoor air contamination. HVAC systems may be shut down to prevent drawing contaminated air inside. Leadership makes the shelter-in-place vs. evacuation decision based on conditions. This is why the EOP must address both options and staff must know which applies.",
        xpReward: 15,
        isSwipe: false,
      },
      {
        id: "em10",
        question: "The Joint Commission minimum requirement for emergency exercises is:",
        options: [
        ...
        correctIndex: 2,
        explanation: "EM.03.01.01 requires a minimum of two emergency exercises per year. At least one must be a community-based exercise that involves external agencies, EMS, fire, public health, or neighboring hospitals. Both must be documented with participation records, critiques, and corrective action tracking.",
        xpReward: 10,
        isSwipe: false,
      },
      {
        id: "em11",
        question: "A hospital conducts its annual emergency drill but does not complete a written critique or identify corrective actions afterward. A surveyor finds the drill documentation. What is the compliance issue?",
        options: [
          "No issue, completing the drill itself satisfies EM.03.01.01",
      ...
      },
      {
        ...
        options: [
          "To allow the Joint Commission to observe the hospital's emergency capabilities directly",
          "To satisfy OSHA requirements for workplace emergency training",
          "To test coordination with external agencies the hospital would rely on during a real community disaster",
          "To reduce malpractice insurance premiums by demonstrating disaster preparedness",
        ],
        correctIndex: 2,
        explanation: "Real community disasters require hospitals to work alongside EMS, fire departments, public health agencies, and neighboring hospitals. Community-based exercises test those inter-agency relationships and communication systems before an actual event. A hospital that only drills internally has never tested whether their communication with the emergency command center actually works under pressure.",
        xpReward: 10,
        isSwipe: false,
      },
      {
        id: "em13",
        question: "A surveyor asks to see documentation of the hospital's last two emergency exercises. The compliance officer presents sign-in sheets but cannot locate critique forms or corrective action logs. What is the finding?",
        options: [
        ...
        correctIndex: 1,
        explanation: "Drill documentation must include more than attendance records. EM.03.01.01 requires documentation of the exercise critique, what worked, what failed, and corrective actions that were identified for improvement. Without these elements, the exercise record is incomplete even if staff actually participated.",
        xpReward: 15,
        isSwipe: false,
      },
      {
      ...
      {
        id: "em15",
        question: "After a mass casualty drill, the AAR identifies three corrective actions: updating radio communication protocols, revising the blood bank surge procedure, and adding an alternate evacuation route to the EOP. Six months later, a surveyor visits. Which question will they most likely ask?",
        options: [
        ...
        correctIndex: 1,
        explanation: "The purpose of the AAR is to drive improvement. EM.04.01.01 requires corrective actions to be tracked to completion, not just identified. Surveyors will look for evidence that the loop was closed: the updated radio protocol, the revised blood bank procedure, and the new evacuation route should all be verifiable in current documentation.",
        xpReward: 15,
        isSwipe: false,
      },
      {
        ...
        correctIndex: 2,
        explanation: "Effective AARs require participation from people who were actually involved in the drill at every level, frontline staff, charge nurses, department leaders, and incident command. Frontline staff often have the most actionable observations about what broke down in practice. Limiting AAR participation to leadership misses the most important operational insights.",
        xpReward: 10,
        isSwipe: false,
      },
      {
        id: "em17",
        question: "A hospital experiences an actual power failure that knocks out main electrical systems for four hours. Does this event require an after-action review under EM.04.01.01?",
        options: [
        ...
        correctIndex: 1,
        explanation: "EM.04.01.01 requires after-action reviews after both emergency exercises and actual emergency events. A real power failure is an actual emergency that activates the EOP's utilities critical area. It must be reviewed to identify how the facility responded, whether the backup systems worked as planned, and what should be improved before the next event.",
        xpReward: 15,
        isSwipe: false,
      },
      {
        id: "em18",
        question: "A Facilities technician is asked by a surveyor: 'What is your role if the hospital activates its Emergency Operations Plan for a utility failure?' The tech responds: 'I'd go to my department and wait for instructions.' How should this response be evaluated?",
        options: [
          ...
          "Unacceptable: the technician should know specific duties such as activating backup generators, checking on medical gas systems, and reporting status to incident command",
          "Unacceptable: utility staff are not part of the EOP and should evacuate during declared emergencies",
        ],
        correctIndex: 2,
        explanation: "Facilities/maintenance staff have critical and specific roles in utility failure emergencies, activating backup systems, monitoring medical gas levels, isolating failed systems, and reporting to incident command. 'Wait for instructions' indicates the technician has not been trained on their EOP role, which is a EM.02.02.01 staff responsibilities finding.",
        xpReward: 15,
        isSwipe: false,
      },
      {
        ...
        options: [
          ...
          "The hospital's plan for managing more patients than its normal licensed capacity during a mass casualty or disaster event",
        ...
        correctIndex: 1,
        explanation: "Surge capacity planning addresses how the hospital will expand its patient care capacity when demand overwhelms normal operations, typically during mass casualty events, community disasters, or pandemics. The EOP must address how the facility will accelerate discharges, open additional care areas, cancel elective procedures, and request mutual aid from neighboring hospitals.",
        xpReward: 10,
        isSwipe: false,
      },
      {
        id: "em20",
        question: "A hospital's Emergency Operations Plan does not address how staff will be notified and assigned during an off-hours emergency when normal supervisors are not present. A surveyor identifies this gap. Which standard does this violate?",
        options: [
        ...
        correctIndex: 1,
        explanation: "Staff responsibilities, including how alternate staffing assignments work when normal supervisors are unavailable, is one of the six critical areas that EM.02.02.01 requires the EOP to address. An EOP that only describes the daytime chain of command fails to account for evenings, weekends, and holidays when many disasters actually occur.",
        xpReward: 15,
        isSwipe: false,
      },
    ],
  },
  {
    ...
    questions: [
      {
        id: "pss1",
        question: "A surgeon skips the surgical time-out because he believes it slows the room down and 'nothing bad has ever happened.' Under Just Culture, how should this behavior be classified and what is the appropriate response?",
        options: [
        ...
        correctIndex: 1,
        explanation: "Skipping a time-out because 'nothing bad has ever happened' is at-risk behavior, the surgeon has drifted from a safe practice, likely not fully recognizing the cumulative risk. The Just Culture response is coaching and creating incentives/redesign that make the safe behavior easier and faster. Reckless behavior requires conscious disregard of a substantial risk; here the behavior is rationalized, not openly defiant.",
        xpReward: 15,
        isSwipe: false,
      },
      {
        id: "pss2",
        question: "A pharmacist catches a look-alike medication that was pulled for the wrong patient before it ever left the pharmacy. No patient was involved. This is best classified as:",
        options: [
        ...
        correctIndex: 2,
        explanation: "A near miss (also called a close call or good catch) is defined as an event that did not reach the patient at all. This pharmacist's catch is a textbook near miss and is high-value for learning. Near misses reveal system vulnerabilities, in this case, look-alike storage, before harm occurs. They must be reported and analyzed, not dismissed because no patient was harmed.",
        xpReward: 10,
        isSwipe: true,
      },
      {
        id: "pss3",
        question: "A sentinel event occurred on Tuesday. By what day must the hospital notify the Joint Commission?",
        options: [
      ...
      {
        id: "pss4",
        question: "A hospital completes a Comprehensive Systemic Analysis of a sentinel event. The only corrective action listed in the action plan is: 'All OR staff will be re-educated on the Universal Protocol.' A surveyor reviews the CSA and flags it as insufficient. Why?",
        options: [
        ...
        correctIndex: 1,
        explanation: "JC's PSS standards require that CSA corrective actions address root causes, the system conditions that enabled the event. 'Re-educate staff' as the sole action treats the event as an individual knowledge failure rather than examining workflow design, communication systems, and environmental factors. Education may be one component, but it cannot be the entire corrective plan. This is one of the most commonly cited CSA deficiencies.",
        xpReward: 15,
        isSwipe: false,
      },
      {
        id: "pss5",
        question: "How long does a hospital have to complete a Comprehensive Systemic Analysis (CSA) after a sentinel event?",
        options: [
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation: "JC requires at least one FMEA per year. The process selected must be high-priority, identified through the organization's risk assessment. FMEA is a proactive tool, meaning it is conducted before an adverse event occurs to identify and redesign vulnerable steps. It is not triggered by events, it runs on its own annual cycle. An organization that only conducts CSAs (reactive) but skips FMEA (proactive) is not meeting the full PSS standard.",
        xpReward: 10,
        isSwipe: true,
      },
      {
        id: "pss7",
        question: "A hospital's safety culture survey reveals that only 38% of staff feel comfortable reporting a safety concern about a physician. Leadership files the survey results with the quality department and takes no further action. Which PSS requirement has the hospital failed to meet?",
        options: [
          "The hospital must resurvey staff within 90 days if any domain scores below 50%",
        ...
        correctIndex: 1,
        explanation: "JC requires that safety culture survey results be used, shared with staff and translated into specific improvement actions. A culture survey that reveals low psychological safety around physician reporting is a significant finding that demands a visible response. Filing results without action defeats the purpose of the survey and signals to staff that leadership is not serious about safety culture. This is a common PSS deficiency.",
        xpReward: 15,
        isSwipe: false,
      },
      {
        id: "pss8",
        question: "How frequently must a hospital measure its safety culture using a validated survey tool?",
        options: [
        ...
        correctIndex: 1,
        explanation: "JC requires safety culture measurement at least every 24 months. The AHRQ Survey on Patient Safety Culture (SOPS) is the most widely used validated tool and is aligned with JC expectations. The 24-month cycle ensures leadership receives current data on staff perceptions of reporting safety, teamwork, communication openness, and management response to errors.",
        xpReward: 10,
        isSwipe: true,
      },
      {
        ...
        correctIndex: 1,
        explanation: "CSA (formerly RCA2) is retrospective, it analyzes what went wrong after a serious safety event. FMEA is prospective, it maps a high-risk process, identifies where it could fail, and redesigns it before harm occurs. Together they form the two-sided PSS improvement cycle: react to events (CSA) and proactively reduce risk (FMEA). Both are required annually; FMEA is not triggered by events.",
        xpReward: 15,
        isSwipe: false,
      },
      {
        id: "pss10",
        question: "A staff nurse reports a medication near miss through the facility's event reporting system. Her manager pulls her aside and tells her the report 'made the unit look bad' and she should think before reporting next time. This situation violates which foundational PSS requirement?",
        options: [
        ...
        correctIndex: 0,
        explanation: "Non-punitive reporting is a core PSS requirement. Staff must feel psychologically safe to report errors, near misses, and safety concerns without fear of blame, discipline, or social pressure. When managers respond to reports with implied punishment or social pressure, staff stop reporting, eliminating the early-warning system that prevents sentinel events. JC surveyors ask frontline staff directly: 'Can you report a safety concern without fear of retaliation?'",
        xpReward: 15,
        isSwipe: false,
      },
      {
        id: "pss11",
        question: "A surveyor asks a bedside RN: 'What would you do if you made a medication error?' The nurse responds: 'I'd probably just monitor the patient closely and tell my charge nurse privately so we don't have to fill out all the paperwork.' How should this response be evaluated?",
        options: [
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation: "A valid CSA requires a multidisciplinary team that includes frontline staff closest to the event, not just leaders and quality professionals. Frontline staff have the most accurate operational knowledge of what actually happened, what workarounds exist, and where the system is fragile. CSAs conducted exclusively by leadership or quality staff often miss the real system factors and produce action plans that don't address actual workflow. This is a common CSA deficiency.",
        xpReward: 10,
        isSwipe: false,
      },
      {
        id: "pss14",
        question: "Which of the five HRO principles is being applied when a charge nurse pauses to investigate why two staff members independently reported that the medication dispensing cabinet was 'hard to use' even though no errors have occurred yet?",
        options: [
        ...
        correctIndex: 2,
        explanation: "Preoccupation with failure means treating small signals, near misses, staff concerns, workarounds, equipment complaints, as potential early warnings of a serious failure. The charge nurse is not waiting for a medication error to investigate; she is acting on staff reports before harm occurs. This is the essence of preoccupation with failure and is contrasted with 'nothing bad has happened yet so it's fine.'",
        xpReward: 15,
        isSwipe: false,
      },
      {
        id: "pss15",
        question: "A hospital's CSA team concludes that a wrong-patient blood transfusion occurred because 'the nurse was distracted and did not follow policy.' The action plan states the nurse will receive disciplinary action and all transfusion nurses will complete an online competency module. A JC reviewer rejects this CSA. What is the most likely reason?",
        options: [
          "The hospital should have filed a CSA within 30 days, not 45 days",
        ...
        correctIndex: 1,
        explanation: "A CSA that concludes 'the nurse was distracted' and prescribes disciplinary action has not identified root causes, it has identified an individual. A valid CSA must examine the system: Was the two-patient identifier verification step clearly designed? Were look-alike labels involved? Was the environment too noisy? What workarounds existed? Root causes are system conditions, not individual failures. Rejecting systemic analysis in favor of individual blame is one of the most common reasons CSAs are returned as insufficient.",
        xpReward: 15,
        isSwipe: false,
      },
      {
        id: "pss16",
        question: "A hospital selects its high-alert medication preparation process for this year's required FMEA. The team maps the process, identifies 23 possible failure modes, scores them by severity and probability, and identifies the top 5 highest-risk steps. What is the required next step?",
        options: [
        ...
        correctIndex: 1,
        explanation: "After scoring and prioritizing failure modes, the FMEA process requires redesigning the process to address the highest-risk steps, implementing those redesigns, and measuring whether the changes achieved the intended risk reduction. An FMEA that stops at identifying risks without implementing and measuring changes has not completed the improvement cycle, and provides no protection against the failures identified. Implementation and measurement are what differentiate an effective FMEA from a paper exercise.",
        xpReward: 15,
        isSwipe: false,
      },
      {
        id: "pss17",
        question: "The governing board of a hospital receives patient safety performance data once a year in a brief slide during the annual report. A JC surveyor notes this as a gap. What does the PSS chapter require of the governing body?",
        options: [
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation: "A precursor safety event is one that reached the patient but resulted in no harm or only minor temporary harm. It is the middle tier of the three-tier classification: near miss (didn't reach patient) → precursor (reached patient, no/minor harm) → serious safety event/sentinel event (reached patient, significant harm). Precursor events are high-value learning opportunities, they reveal system vulnerabilities that, if not corrected, may result in a serious event the next time.",
        xpReward: 10,
        isSwipe: true,
      },
      {
        id: "pss19",
        question: "A hospital has conducted its annual PSS program evaluation. To whom must this evaluation be formally presented?",
        options: [
          ...
          "The Joint Commission field representative assigned to the facility",
        ],
        correctIndex: 2,
        explanation: "The annual PSS program evaluation must be presented to both hospital leadership and the governing body. This ensures board-level visibility into whether the safety program is functioning, whether events are being reported, CSAs completed on time, FMEAs conducted, and culture surveys acted upon. Presenting only to the medical executive committee or quality department does not satisfy the board accountability requirement.",
        xpReward: 10,
        isSwipe: false,
      },
      {
        id: "pss20",
        question: "A surveyor asks a frontline nurse: 'If you saw something unsafe happening to a patient right now, what would you do?' The nurse replies: 'I would speak up immediately, and if needed I would use the chain of command or our safety reporting system, I wouldn't stay quiet just because someone outranks me.' Which HRO principle does this response best demonstrate?",
        options: [
        ...
        correctIndex: 2,
        explanation: "Deference to expertise means that in safety-critical moments, authority flows to whoever has the most relevant knowledge and clearest view of the risk, regardless of rank. The nurse's willingness to speak up and escalate past hierarchy demonstrates this principle in practice. This is a strong surveyor response. JC looks for staff who understand they have both the right and the responsibility to escalate safety concerns even when it means challenging someone with higher authority.",
        xpReward: 15,
        isSwipe: false,
      },
    ],
