    ...
    questions: [
      ...
      baseCorrectIndex: 2,
        ...
        followUps: [{
          ...
          options: [
          "UV-C cycle logs alone are sufficient documentation since the robot provides a standardized, automated disinfection cycle with validated parameters. The technology's automated nature and timestamp verification ensure that the supplemental disinfection process is being performed correctly as designed.",
          ...
          "UV-C logs showing completed cycles are a stronger form of evidence than manual cleaning checklists—automated technology documentation provides objective, time-stamped, sensor-verified data that eliminates self-reporting bias. Relying on automated UV-C records rather than manual documentation creates a more reliable and defensible compliance audit trail.",
          "The perioperative director should delegate this documentation question to EVS management since environmental cleaning documentation falls under the EVS department's scope of responsibility. The director's role is to ensure that UV-C is deployed, not to maintain detailed records of prerequisite manual cleaning steps.",
        ],
        correctIndex: 1,
      ...
      baseCorrectIndex: 0,
        ...
        followUps: [{
          ...
          options: [
          "Monthly spot-checks by the infection preventionist are sufficient oversight per APIC infection prevention program management guidelines, which recommend infection preventionist-led environmental rounds at minimum monthly frequency for equipment verification and systematic monitoring of all facility equipment and system maintenance activities",
          "Replacing all dilution systems with pre-mixed chemicals to eliminate variables and human preparation error, using only factory-guaranteed EPA-registered disinfectants that provide consistent concentrations while reducing staff training burden and potential for concentration errors during mixing",
          ...
          "A more experienced supervisor who can visually assess chemical concentration by color intensity and solution viscosity—senior EVS supervisors with 10+ years of experience develop reliable organoleptic assessment skills per ASSE Series 7000 standards and industry best practices for equipment evaluation",
        ],
        correctIndex: 1,
      ...
      baseCorrectIndex: 1,
        ...
        followUps: [{
          ...
          options: [
          "ATP testing is unreliable for evaluating the tag system because ATP bioluminescence measures total organic adenosine triphosphate from both microbial and non-microbial sources, and elevated ATP readings may reflect non-pathogenic organic contamination that does not represent actual infection risk to patients or represent a failure of the equipment disinfection process.",
          ...
          "The tag system is too complicated for a fast-paced clinical environment and should be abandoned in favor of a simpler time-based protocol—SHEA equipment cleaning guidelines recommend scheduled interval cleaning as an evidence-based alternative to event-based cleaning verification systems in high-volume surgical and procedural settings.",
          "Increase the number of green tags available at the point of use near all cleaning supply stations—providing immediate tag access at the location where equipment is cleaned increases tagging compliance rates and reduces the time burden on environmental services and nursing staff who perform equipment disinfection tasks.",
        ],
        correctIndex: 0,
    ...
    questions: [
      ...
      baseCorrectIndex: 1,
        ...
        followUps: [{
          ...
          "Acknowledge the overlap and present a revised staffing plan that staggers shift changes by 45 minutes to restore temporal separation, with a 90-day implementation timeline approved by the SPD medical director. This approach eliminates the simultaneous clean and soiled traffic condition by distributing the shift change across a longer period, reducing the risk window during which both types of traffic occur.",
          "Show validated cleaning logs demonstrating the corridor receives terminal-level disinfection with EPA-registered compounds and 10-minute contact time, verified by ATP testing below 250 RLU. Enhanced cleaning frequency during overlap periods provides documented environmental decontamination that mitigates the risk of cross-contamination between clean and soiled instruments during the shared corridor use window.",
          "Present the facility's 36-month surgical site infection trending data showing 0.3% versus 1.9% national benchmark, demonstrating superior patient outcomes under the current system. The facility's strong infection rate performance indicates that despite the overlap condition, actual patient harm has not occurred, suggesting the current practice is clinically safe.",
        ],
        correctIndex: 0,
      ...
      },
      {
        ...
        baseOptions: [
          "Concern because the sterilization process eliminates all contamination making cross-access between clean and sterile zones irrelevant to infection prevention",
          "AAMI ST79 confirms sterilizer loading areas are classified as transitional zones and dual-access from clean and sterile sides is the standard industry configuration",
          ...
          "A concern only if pass-through sterilizers are not used - pass-through design inherently prevents cross-zone traffic contamination issues and eliminates the need for access control",
        ],
      baseCorrectIndex: 2,
